      ...
      <Container width="1360px">
        <BannerContentWrapper>
          <BannerContent>
            ...
            Minimise your energy wastage through tailored, AI-powered optimisation.
            </h2>
            <Text
              className="animate__animated animate__fadeInUp"
              content="
              Welcome to Enzum, 
              your trusted partner in grid optimisation solutions.
               

              "
            />
    
              {/* <Button title="Contact Us" className="button-one" /> */}
